...
const translations: any = {
    es: {
        ...
        'setup.criteria.rfp_info': 'Para RFP se evalúan criterios técnicos, económicos y de experiencia.',
        'setup.criteria.rfq_info': 'Para RFQ el peso económico suele ser mayor (>50%).',
    ...
    en: {
        ...
        'setup.criteria.rfp_info': 'For RFP, technical, economic, and experience criteria are evaluated.',
        'setup.criteria.rfq_info': 'For RFQ, economic weight is usually higher (>50%).',
